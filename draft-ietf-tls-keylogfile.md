...
given connection, these labels MUST be followed by Random from Inner ClientHello.
...
: This label corresponds to the KEM shared secret derived during the HPKE key schedule process.
